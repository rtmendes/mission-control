...
export function LiveFeed({ mobileMode = false, isPortrait = true }: LiveFeedProps) {
  ...
  return (
    <aside
      className={`flex-none bg-mc-bg-secondary ${mobileMode ? 'border border-mc-border rounded-lg h-full' : 'border-l border-mc-border'} flex flex-col transition-all duration-300 ease-in-out ${
